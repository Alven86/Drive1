                ...
                if(dataSnapshot.exists()){
                    ...
                    if(dataSnapshot.child("customerPaid").getValue() != null && dataSnapshot.child("driverPaidOut").getValue() == null){
                        if(dataSnapshot.child("distance").getValue() != null){
                            ...
                            Balance += ridePrice;
                            mBalance.setText("Balance: " + String.valueOf(Balance) + " kr");
                        }
                    }
...
//get date and time
    ...
    private void payoutRequest() {
        ...
        RequestBody body = RequestBody.create(MEDIA_TYPE,
                postData.toString());
// I HAVE IMPLEMENT PAY METHOD BY PAYPAL TO WORK WE MOST CREATE AN URL TO PAY THROW AND UPPGRADE DB TO PAY OUT SIDE DB.
        final Request request = new Request.Builder()
                .url("HERE WE WILL PUT THE PAYMENT URL TO PAY OUT SIDE OUR DB")
                .post(body)
